...
const searchAnime = mal_scraper_1.search; // MalScraper client
malScraperRouter.get('/getFromMalScraper', async (req, res) => {
    const queryName = req.query.anime_name;
    const animeArray = await searchAnime.search("anime", { term: queryName });
